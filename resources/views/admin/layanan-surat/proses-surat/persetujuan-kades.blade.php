...
<html lang="en">
    <head>
        ...
        <title>Persetujuan Kepala Desa - Laman Admin Desa Rawapanjang</title>
        <style>
            body {
        ...
        <div class="main-content">
            ...
            <div class="content">
                <div class="mt-4">
                    ...
                    <br>
                    <p>Surat telah diverlifikasi oleh Administrator</p>
                    <p>Mohon lakukan tanda tangan secara digital apabila surat yang warga ajukan ini telah sesuai ketentuan.</p>
                </div>
                ...
                <!-- Kondisi Surat Diverifikasi -->
                    <div class="lightbox_container" id="verifLightbox">
                        <div class="lightbox_content">
                            ...
                            <p>Setelah ditandatangan, surat ini akan dilanjutkan kepada administrator desa untuk diserahkan kepada warga.</p>
                    ...
                    <div class="lightbox_container" id="doneDenyLightbox">
                        <div class="lightbox_content">
                            ...
                            <p>Anda dapat kembali melihat surat ini di menu
                                <br>Layanan Surat > Arsip Surat Ditolak</p>
                            <!-- Menangani aksi saat tombol "Verifikasi" diklik -->
