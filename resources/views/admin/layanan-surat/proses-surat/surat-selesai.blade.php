    ...
    <body>
                ...
                <div class="content-1">            
                    <div class="mt-4">
                        ...
                        <div class="template-pesan">
                            <p>Pesan bahwa surat telah selesai diproses, surat dapat diunduh di link gdrive atau dapat diambil di kantor desa.</p>
                        </div>
                        <p>Kirim Pesan:</p>
                        <button>Tandai Sudah Dikirim</button>
                    </div>
                </div>
                <div class="content-2">            
                    ...
                    <div class="button-container">
                        ...
                        <button>Tandai Sudah Dicetak</button>
                    </div>
                </div>
                <!-- Lightboxes -->
        ...
        <div class="footer">
            <div class="footer-content">
                ...
                <button>Tandai Sudah Diserahkan</button>
            </div>
            <div class="credit">
                <p>&copy;</p>
            </div>
