...
<head>
    ...
    <style>
        ...
        .nav-link.active {
            padding: 0;
            border: 3px solid;
            border-image: linear-gradient(to right, #FF8A00, #F7E700);
        }
        .nav-link {
            color: black;
        }
...
<body>
    <div class="d-flex">
        <!-- Sidebar -->
        <nav class="bg-white text-black p-3 vh-100" style="width: 250px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="#" class="nav-link">Informasi Desa</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Data Warga</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Statistik Desa</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link active">Layanan Surat</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Pengumuman</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Artikel Desa</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Agenda Desa</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link">Pengaturan Akun</a></li>
            </ul>
        </nav>
