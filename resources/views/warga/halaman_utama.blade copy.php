...
@section('content')
        <div class="video-container">
            ...
            <!-- <iframe width="560" height="315" src="https://youtu.be/TwoWCMDQ2ag?si=nr8b7YUDVzcg9VvQ" 
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                allowfullscreen>
            </iframe> -->
            <video autoplay muted loop width="1080" height="460"> <!-- controls -->
                <source src="{{ asset('assets/PROFIL-DESA-RAWA-PANJANG-2022.mp4') }}" type="video/mp4" >
