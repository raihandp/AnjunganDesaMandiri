        ...
        <div class="login-container">
            ...
            <form action="{{ url('/login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="pin" name="pin" placeholder="Masukkan PIN Anda" required>
                </div>
                <div class="button-container" style="margin: -20px;"> 
                    <button type="submit" class="button" onclick="window.location.href='/pilih-surat';">Masuk</button>
                </div> 
            </form>
